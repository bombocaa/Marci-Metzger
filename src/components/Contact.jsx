    ...
    <section id="contact">
      <div className="bg-[#FAF7F2] py-24 px-8 md:px-16 border-t border-[#E2DAD0]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10 items-start">
          ...
          {/* Column 2: Hours */}
          <div className="flex flex-col h-full pt-6 lg:pt-28">
            <p className="text-[10px] tracking-[0.3em] uppercase text-[#8A8075] mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
              Hours of Operation
            </p>
          ...
          <div className="flex flex-col justify-between h-full pt-1">
            <div>
              ...
              <a
                ...
                className="block text-xs text-[#5C544D] hover:text-[#24211E] leading-relaxed mb-4 group transition-colors"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
            ...
            {/* Embedded Google Map */}
            <div className="w-full h-[240px] sm:h-[260px] overflow-hidden border border-[#E2DAD0] shadow-xs relative bg-[#E5E3DF]">
              <iframe
      ...
      <footer
        className="py-14 px-8 md:px-16"
        style={{ backgroundColor: "#1E1B18" }}
      >
        <div className="max-w-7xl mx-auto flex flex-col gap-10">
          {/* Row 1: Logo & Navigation */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-10 border-b border-[#36312C]">
            ...
            <nav className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
              {[
                ...
                <a
                  key={item.label}
                  href={item.href}
                  className="text-xs tracking-widest uppercase text-[#FAF7F2]/70 hover:text-[#FAF7F2] transition-colors"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  {item.label}
                </a>
          ...
          {/* Row 2: Office Address, Direct Phone & Social Media */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-10 border-b border-[#36312C] text-center md:text-left">
            {/* Address */}
            <a
              href="https://www.google.com/maps?daddr=3190+HW-160,+Suite+F,+Pahrump,+Nevada+89048,+United+States"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-[#FAF7F2]/70 hover:text-[#FAF7F2] transition-colors flex items-center justify-center md:justify-start gap-2"
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              <span>3190 HW-160, Suite F, Pahrump, Nevada 89048</span>
              <span className="text-[10px] text-[#FAF7F2]/40 underline underline-offset-2">(Directions ↗)</span>
            </a>

            {/* Direct Phone */}
            <a
              href="tel:2069196886"
              className="text-sm font-semibold text-[#FAF7F2] hover:text-[#FAF7F2]/80 transition-colors"
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              (206) 919-6886
            </a>
            ...
            <div className="flex items-center gap-5">
              {["Facebook", "Instagram", "LinkedIn", "Yelp"].map((label) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="text-[10px] tracking-widest uppercase text-[#FAF7F2]/60 hover:text-[#FAF7F2] transition-colors"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  {label}
                </a>
          ...
          {/* Row 3: Copyright & Disclaimers */}
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-[#FAF7F2]/40 text-center sm:text-left">
            <p style={{ fontFamily: "'Inter', sans-serif" }}>
              © {new Date().getFullYear()} Marci Metzger Homes. All Rights Reserved.
            </p>
            <p style={{ fontFamily: "'Inter', sans-serif" }}>
              The Ridge Realty Group · Equal Housing Opportunity · Nevada Real Estate
            </p>
          </div>
        </div>
      </footer>
