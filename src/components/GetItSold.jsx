  ...
  return (
    <section className="bg-white py-28 px-8 md:px-16 border-t border-black/5">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20">
          <h2 className="text-5xl md:text-7xl font-medium text-black leading-none" style={{ fontFamily: "'Playfair Display', serif" }}>
        ...
        <div className="grid md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="md:col-span-5 flex flex-col justify-end pb-6">
            <p className="text-black/20 text-xs uppercase tracking-widest mb-4" style={{ fontFamily: "'Inter', sans-serif" }}>
              Top Residential Sales · Last 5 Years
            </p>
            <p className="text-black/55 leading-[1.75] text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="grid md:grid-cols-12 gap-8">
          <div className="md:col-span-5 flex flex-col justify-end pb-6 order-last md:order-first">
            <h3 className="text-2xl md:text-3xl font-medium text-black mb-4 leading-snug" style={{ fontFamily: "'Playfair Display', serif" }}>
              Don't just list it —<br />get it <em>sold.</em>
            </h3>
            <p className="text-black/45 leading-[1.75] text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
